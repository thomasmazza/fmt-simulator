...
bool MirrorRectangle::hitComponent(Photon &p, std::vector<double> &_dirOA) {
    double rS = 0;
    double lS = 0;
...
bool MirrorRectangle::getOutDir(Photon &p, std::vector<double> &intersect, std::vector<double> &normWidth) {
